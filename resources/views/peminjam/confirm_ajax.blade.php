...
@else
<form action="{{ url('/peminjam/' . $peminjam->id_pinjam . '/delete_ajax') }}" method="POST" id="form-delete">
    @csrf
    @method('DELETE')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-warning">
                    ...
                    Apakah Anda yakin ingin menghapus data peminjaman berikut ini?
                </div>
                <table class="table table-sm table-bordered table-striped">
                    ...
                    <tr>
                        <th class="text-right col-3">username Peminjam :</th>
